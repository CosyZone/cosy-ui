...
import { CodeExample, getExampleImage, getProductImage, getAvatarImage, getLandscapeImage } from '@/index';
...
>
  <div class="cosy:grid cosy:grid-cols-3 cosy:gap-4">
    <div>
      <p class="cosy:text-sm cosy:mb-2">灰度:</p>
      <Image src={getExampleImage({ width: 300, height: 200, grayscale: true, randomSeed: 'effect1' })} alt="灰度示例" />
    </div>
    <div>
      <p class="cosy:text-sm cosy:mb-2">模糊:</p>
      <Image src={getExampleImage({ width: 300, height: 200, blur: 5, randomSeed: 'effect1' })} alt="模糊示例" />
    </div>
    <div>
      <p class="cosy:text-sm cosy:mb-2">灰度 + 模糊:</p>
      <Image src={getExampleImage({ width: 300, height: 200, grayscale: true, blur: 5, randomSeed: 'effect1' })} alt="组合效果示例" />
    </div>
  </div>
</CodeExample>
...
>
  <div class="cosy:grid cosy:grid-cols-3 cosy:gap-4">
    <div>
      <p class="cosy:text-sm cosy:mb-2">产品图片:</p>
      <Image src={getProductImage({ randomSeed: 'special1' })} alt="产品图片示例" />
    </div>
    <div>
      <p class="cosy:text-sm cosy:mb-2">头像图片:</p>
      <Image src={getAvatarImage({ randomSeed: 'user1' })} alt="头像图片示例" rounded="full" />
    </div>
    <div>
      <p class="cosy:text-sm cosy:mb-2">景观图片:</p>
      <Image src={getLandscapeImage({ tag: 'mountain' })} alt="景观图片示例" />
    </div>
  </div>
</CodeExample>
