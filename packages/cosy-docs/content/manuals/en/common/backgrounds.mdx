...
import PatternShowcaseEn from '@/components/backgrounds/PatternShowcaseEn.astro';
...
- `dot-grid` - Subtle dot grid (follows theme base-300 tone)
- `dot-grid-soft` - Softer dot grid
- `dot-grid-lg` - Larger spacing dot grid
