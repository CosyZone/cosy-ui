...
Array of images arranged from left to right, with the center position automatically becoming the focal point, displayed largest and clearest. **Must provide an odd number of images (minimum 3)**.
