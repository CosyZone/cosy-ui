...
- Multiple preset background color themes including default, light, dark, blue, green, purple, orange, and red
...
Choose different background color themes using the bgType property:
