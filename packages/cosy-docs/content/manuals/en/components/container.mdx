...
### background
Background color type, supporting all Tailwind background colors and opacity variants, such as: base-100, primary, secondary, accent, neutral, info, success, warning, error, and opacity variants like primary/10, secondary/20, etc.
