...
Arrow button style variant, optional values: ghost, outline, primary, secondary.
...
Whether to show left and right navigation arrows, displays scroll arrows on both sides of the image row when set to true.

<ImageRowPackage.Arrows />

### showDots

Whether to show bottom dot indicators, displays dot indicators at the bottom of the image row when set to true.

<ImageRowPackage.Dots />
