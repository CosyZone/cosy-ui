...
Vertical margin size, supports preset size values.

<AlertVuePackage.MarginY />

### showIcon

Whether to display the icon, setting to false will hide the icon corresponding to the type.
...
Style variant, supports solid (filled), outline (bordered), dash (dashed), soft (soft) four styles.
