import ImagesCircleExample from './ImagesCircleExample.astro';
...
import ImagesCircleSpacingContainer from './ImagesCircleSpacingContainer.astro';

export const ImagesCirclePackage = {
    Example: ImagesCircleExample,
    ...
    SpacingContainer: ImagesCircleSpacingContainer,
};
