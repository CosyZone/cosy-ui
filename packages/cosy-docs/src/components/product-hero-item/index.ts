import ProductHeroItemExampleContainer from './ProductHeroItemExampleContainer.astro';
import ProductHeroItemNameContainer from './ProductHeroItemNameContainer.astro';
import ProductHeroItemDescriptionContainer from './ProductHeroItemDescriptionContainer.astro';
import ProductHeroItemImageContainer from './ProductHeroItemImageContainer.astro';
...
import ProductHeroItemOnBuyNowContainer from './ProductHeroItemOnBuyNowContainer.astro';
import ProductHeroItemOnLearnMoreContainer from './ProductHeroItemOnLearnMoreContainer.astro';
import ProductHeroItemClassContainer from './ProductHeroItemClassContainer.astro';

export const ProductHeroItemPackage = {
    Example: ProductHeroItemExampleContainer,
    Name: ProductHeroItemNameContainer,
    Description: ProductHeroItemDescriptionContainer,
    Image: ProductHeroItemImageContainer,
    ...
    OnBuyNow: ProductHeroItemOnBuyNowContainer,
    OnLearnMore: ProductHeroItemOnLearnMoreContainer,
    Class: ProductHeroItemClassContainer,
};
