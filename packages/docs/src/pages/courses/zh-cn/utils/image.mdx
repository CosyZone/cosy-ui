...
import { CodeExample, getExampleImage, getProductImage, getAvatarImage, getLandscapeImage } from 'packages/astro/src/index';
import { Image } from 'packages/astro/src/index';
