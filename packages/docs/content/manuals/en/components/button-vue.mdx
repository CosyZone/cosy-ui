...
Click event handler function, supporting function type.

<ButtonVuePackage.OnClick />
...
In addition, the following gradient variants are supported:

<ButtonVuePackage.GradientVariants />
