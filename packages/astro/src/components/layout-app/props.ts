...
export function createAppLayoutProps(
	initial: Partial<IAppLayoutAllProps> = {},
): IAppLayoutPropsBuilder {
	...
	const api: IAppLayoutPropsBuilder = {
		...
		bodyOnly(value = false) {
			props = { ...props, bodyOnly: value };
			return api;
		},
