 ...
 * @returns CSS 类名字符串
 */
export function getContainerMinHeightClass(
	headerHeight: HeaderHeight = "md",
): string {
	...
	return heightValueMap[headerHeight] || "cosy:min-h-[calc(100vh-3rem)]";
}
 ...
 * @returns CSS 类名字符串
 */
export function getSidebarHeightClass(
	headerHeight: HeaderHeight = "md",
): string {
	const heightValueMap = {
