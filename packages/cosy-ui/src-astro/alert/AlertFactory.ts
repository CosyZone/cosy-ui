...
export class AlertFactory {
	private props: Partial<IAlertProps> = {};
	...
	withClass(className: string): AlertFactory {
		this.props = { ...this.props, class: className };
		return this;
	}
	...
	withClosable(closable: boolean): AlertFactory {
		this.props = { ...this.props, closable };
		return this;
	}
	...
	withShowIcon(showIcon: boolean): AlertFactory {
		this.props = { ...this.props, showIcon };
		return this;
	}
	 ...
	 */
	info(): AlertFactory {
		this.props = { ...this.props, type: "info" };
		return this;
	}
	...
	success(): AlertFactory {
		this.props = { ...this.props, type: "success" };
		return this;
	}
	...
	warning(): AlertFactory {
		this.props = { ...this.props, type: "warning" };
		return this;
	}
	 ...
	 */
	error(): AlertFactory {
		this.props = { ...this.props, type: "error" };
		return this;
	}
