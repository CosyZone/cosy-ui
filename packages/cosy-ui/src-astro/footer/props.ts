...
export interface IFooterPropsBuilder {
	 ...
	 */
	background(
		value: NonNullable<IFooterProps["background"]>,
	): IFooterPropsBuilder;
	/** 设置 Logo。
	 * @param value 图片源
	 * @returns IFooterPropsBuilder
	 ...
	 */
	friendlyLinks(
		value: NonNullable<IFooterProps["friendlyLinks"]>,
	): IFooterPropsBuilder;
	/** 设置社交链接。
	 ...
	 */
	socialLinks(
		value: NonNullable<IFooterProps["socialLinks"]>,
	): IFooterPropsBuilder;
	/** 设置微信二维码。
	 * @param value 图片源
	 * @returns IFooterPropsBuilder
	...
	/** 设置信息。*/
	contactInfo(
		value: NonNullable<IFooterProps["contactInfo"]>,
	): IFooterPropsBuilder;
	/** 设置法律信息。*/
	legalInfo(value: NonNullable<IFooterProps["legalInfo"]>): IFooterPropsBuilder;
	/** 设置资源信息。*/
	resourcesInfo(
		value: NonNullable<IFooterProps["resourcesInfo"]>,
	): IFooterPropsBuilder;
