...
export { default as IPhoneBatteryIcon } from './IPhoneBatteryIcon.astro';
export { default as IPhoneSignalIcon } from './IPhoneSignalIcon.astro';
export { default as IPhoneWifiIcon } from './IPhoneWifiIcon.astro';
