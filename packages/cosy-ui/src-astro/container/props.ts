...
export interface IContainerPropsBuilder {
     ...
     * @returns IContainerPropsBuilder
     */
    background(value: NonNullable<IContainerProps['background']>): IContainerPropsBuilder;

    /** 设置背景图片源。
     * @param value 本地 ImageMetadata 或远程 URL
     * @returns IContainerPropsBuilder
     */
    backgroundImage(value: NonNullable<IContainerProps['backgroundImage']>): IContainerPropsBuilder;
     ...
     * @returns IContainerPropsBuilder
     */
    contentBorder(value?: NonNullable<IContainerProps['contentBorder']>): IContainerPropsBuilder;
     ...
     * @returns IContainerPropsBuilder
     */
    justify(value: NonNullable<IContainerProps['justify']>): IContainerPropsBuilder;
     ...
     * @returns IContainerPropsBuilder
     */
    padding(value: NonNullable<IContainerProps['padding']>): IContainerPropsBuilder;

    /** 圆角。
     * @param value 预设 rounded 尺寸
     * @returns IContainerPropsBuilder
     */
    rounded(value: NonNullable<IContainerProps['rounded']>): IContainerPropsBuilder;
...
export function createContainerProps(initial: Partial<IContainerProps> = {}): IContainerPropsBuilder {
    ...
    const api: IContainerPropsBuilder = {
        ...
        aspectRatio(value) { props = { ...props, aspectRatio: value }; return api; },
        ...
        backgroundImage(value) { props = { ...props, backgroundImage: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.border */
        border(value = true) { props = { ...props, border: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.fit */
        fit(value) { props = { ...props, fit: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.contentBorder */
        contentBorder(value = true) { props = { ...props, contentBorder: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.centered */
        centered(value = true) { props = { ...props, centered: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.contentCentered */
        contentCentered(value = true) { props = { ...props, contentCentered: value }; return api; },
        ...
        flex(value) { props = { ...props, flex: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.gap */
        gap(value) { props = { ...props, gap: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.height */
        height(value) { props = { ...props, height: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.items */
        items(value) { props = { ...props, items: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.justify */
        justify(value) { props = { ...props, justify: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.margin */
        margin(value) { props = { ...props, margin: value }; return api; },
        ...
        rounded(value) { props = { ...props, rounded: value }; return api; },
        /** @inheritDoc IContainerPropsBuilder.width */
        width(value) { props = { ...props, width: value }; return api; },
