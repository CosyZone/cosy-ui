...
export interface IMainPropsBuilder {
    ...
    classList(value: NonNullable<IMainContentProps['class:list']>): IMainPropsBuilder;
    /** HTML id 属性 */
    ...
    /** 当前语言（目录等功能依赖） */
    currentLocale(value: NonNullable<IMainContentProps['currentLocale']>): IMainPropsBuilder;
 ...
 */
export function createMainProps(initial: Partial<IMainContentProps> = {}): IMainPropsBuilder {
